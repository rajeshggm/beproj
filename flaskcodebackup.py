...
def upload_filee():
   if request.method == 'POST':
      ...
      imgname = f.filename
      print (imgname)
      scores, predictions = demo.predict(imgname, "what is there")
#scores = [score * 100 for score in scores]
#df = pd.DataFrame({
#  "Prediction": predictions,
#  "Confidence": scores
#})
      print (predictions[0])
      return render_template("upload.html", name = imgname)
...
#image = Image.open(image_path)
      ...
      scores, predictions = demo.predictmm(image_text, question_text)
      #scores = [score * 100 for score in scores]
      print (predictions[0])
      torch.cuda.empty_cache()
